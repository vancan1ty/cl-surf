...
(defun create-file-index (string-input url &optional (title "") (description nil) (keywords nil) (outgoinglinks nil))
...
(defun file-index-to-string (fileindex)
  (with-slots (url title keywords description timeindexed keywords-freq-hash nwords-in-kfh outgoinglinks totnumwords position-hash) fileindex
    (list 
     :url url
     :title title
     :keywords keywords
